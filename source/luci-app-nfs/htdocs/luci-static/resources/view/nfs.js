...
return view.extend({
	...
	render: function(stats) {
		...
		o = s.taboption('advanced', form.Value, 'threads', _('Number of threads'));
		o.datatype = 'uinteger';
		o.default = '16';
		o.placeholder = '16';
		...
		o = s.taboption('advanced', form.Flag, 'tcp', _('Enable TCP'));
		o.default = '1';
		o.rmempty = false;

		o = s.taboption('advanced', form.Flag, 'udp', _('Enable UDP'));
		o.default = '0';
		o.rmempty = false;
